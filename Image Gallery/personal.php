...
<body>
    ...
    <main>
        <div class="main-container">
            <div class="con" style="margin:auto;width: 800px;padding:20px;">
                ...
                <div class="Personal">
                    <a href="profile.php"><button id="button">Back to Our Picture</button></a>
                </div>
            </div>
    ...
    <main>
        <div class="main-container">
            <?php
                $id=$_SESSION['userid'];
                $show=$ob->getuserpersonaldata($id);
                if(isset($show))
                {
                    foreach($show as $s)
                    {
                    ...
                    ?>
                    <h1 style="padding: 30px;">You Have Not Upload Any Personal Picture in your Account</h1>
                    <?php
                }
            ?>
